...
public class BuscarSubcadenas
{
    ...
    /* @brief   Programa que pide por teclado una cadena y una subcadena, las valida y muestra el número de veces que
     *          se repite la subcadena dentro de la cadena y las posiciones en las que se producen.
     */
    public static void main(String[] args)
    {
        /*
         * Llamada al método mostrarSubcadenas para mostrar las coincidencias de una subcadena en una cadena,
         * ambas pedidas por teclado.
         */
        mostrarSubcadenas();
    }
